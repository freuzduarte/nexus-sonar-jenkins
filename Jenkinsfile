    ...
    stages {
      ...
      steps {
        script {
          ...
          sh """
            docker run -v ${soapUiTestDir}:/project -v ${soapUiReportDir}:/reports -e COMMAND_LINE="-f/reports REST-Project-2-soapui-project.xml" -it smartbear/soapuios-testrunner
          """
