    ...
    stages {
      ...
      steps {
        script {
          ...
          sh """
            docker run -it -v ${soapUiTestDir}:/project -v ${soapUiReportDir}:/reports -e COMMAND_LINE="-f/%reports% '/%project%/REST-Project-2-soapui-project.xml'" smartbear/soapuios-testrunner
          """
